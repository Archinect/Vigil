...
/proc/to_chat(target, message)
	...
	//Otherwise, we're good to throw it at the user
		...
		message = replacetext(message, "A", "&#1040;")
		message = replacetext(message, "A", "&#1041;")
		message = replacetext(message, "A", "&#1042;")
		message = replacetext(message, "A", "&#1043;")
		message = replacetext(message, "A", "&#1044;")
		message = replacetext(message, "A", "&#1045;")
		message = replacetext(message, "?", "&#1046;")
		message = replacetext(message, "C", "&#1047;")
		message = replacetext(message, "E", "&#1048;")
		message = replacetext(message, "E", "&#1049;")
		message = replacetext(message, "E", "&#1050;")
		message = replacetext(message, "E", "&#1051;")
		message = replacetext(message, "I", "&#1052;")
		message = replacetext(message, "I", "&#1053;")
		message = replacetext(message, "I", "&#1054;")
		message = replacetext(message, "I", "&#1055;")
		message = replacetext(message, "?", "&#1056;")
		message = replacetext(message, "N", "&#1057;")
		message = replacetext(message, "O", "&#1058;")
		message = replacetext(message, "O", "&#1059;")
		message = replacetext(message, "O", "&#1060;")
		message = replacetext(message, "O", "&#1061;")
		message = replacetext(message, "O", "&#1062;")
		message = replacetext(message, "?", "&#1063;")
		message = replacetext(message, "O", "&#1064;")
		message = replacetext(message, "U", "&#1065;")
		message = replacetext(message, "U", "&#1066;")
		message = replacetext(message, "U", "&#1067;")
		message = replacetext(message, "U", "&#1068;")
		message = replacetext(message, "Y", "&#1069;")
		...
		message = replacetext(message, "y", "&#1101;")
		message = replacetext(message, "?", "&#1102;")
		message = replacetext(message, "y", "&#1103;")
