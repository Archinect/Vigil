...
/obj/machinery/vending/boozeomat
	...
	product_slogans = "Надеюсь, что никто не попросит у меня чашечку крови..;Алкоголь - друг человека. Почему ты оставляешь своего друга?;Мы рады обслуживать вас!;Никого не мучает жажда на станции?"
	product_ads = "Выпей!;Напитки - то, что тебе надо!;Алкоголь - лучший друг человека.;Мы рады обслуживать вас!;Надо заботиться о хороших вещах, холодного пива?;Ничто не вылечит тебя так, как напиток!;Сделай глоток!;Возьми себе напиток!;Не хочешь пива?;Пиво будет отличным выбором!;Только лучший алкоголь!;Лучшее для работников с 2053-го года!;Лучшее вино!;Максимум алкоголя!;Мужикам понравится пиво!;Тост за научный прогресс!"
...
/obj/machinery/vending/snack
	...
	product_slogans = "Попробуй наш новый Нуга-Батончик!;Половина калорий за двойную цену!;Гораздо лучше, чем у Дэна!"
	product_ads = "Самая здоровая пища!;Лучшие в мире шоколадные батончики!;Мммм! Как вкусно!;Ох Господи, он такой сочный!;Возьми с собой шоколадку!;Только лучшая еда с Марса!;Мы любим шоколад, а ты?!;Попробуй наше новое мясо!"
	icon_state = "snack"
	products = list(
...
/obj/machinery/vending/cola
	...
	product_slogans = "Робаст Софтдринкс: Робастнее, чем удар тулбоксом в голову!;Мы не работаем на Дэна!"
	product_ads = "Освежает!;Надеюсь, тебя мучает жажда!;Продано более миллиона напитков!;Мучает жажда? Не желаешь колы?;Попробуй наш новый Горный Ветер!;Лучшие напитки в космосе."
	products = list(
...
/obj/machinery/vending/cart
	...
	product_slogans = "Разбирайте картриджи!"
	icon_state = "cart"
	icon_deny = "cart-deny"
	products = list(
...
/obj/machinery/vending/cigarette
	...
	product_slogans = "Космо-сигареты! На вкус как сигареты.;Лучше получить тулбоксом по голове, чем остаться без сигарет!;Сигареты!;Не верь слухам - начни курить сейчас!"
	product_ads = "Однозначно неплохой выбор для тебя!;Не верь учёным!;Курить не вредно!;Не экономь деньги, бери ещё!;Сигареты!;Никотиновый рай.;Лучшие сигареты 2150-го года.;Ты не пожалеешь!"
	icon_state = "cigs"
	products = list(
...
/obj/machinery/vending/medical
	...
	icon_state = "med"
	icon_deny = "med-deny"
	product_ads = "Давай спасём людские жизни?;Все, что нужно настоящему врачу!;Только лучшие лекарства!;Чистая химия!;Я и ты поможем людям!;Бери ещё!;Ping!"
	products = list(
...
/obj/machinery/vending/wallmed1
	...
	//req_access = list(access_medical)
	product_ads = "Давай спасём людские жизни?;Все, что нужно настоящему врачу!;Только лучшие лекарства!;Чистая химия!;Я и ты поможем людям!;Бери ещё!"
	icon_state = "wallmed"
...
/obj/machinery/vending/hydronutrients
	...
	product_slogans = "Неужели ты не хочешь получить настоящие удобрения??;Пахнет на 50% слабее!;Растения - тоже люди!"
	product_ads = "Мы любим растения!;Не хочешь немного удобрений?;Самая качественная продукция.;Нам нравятся большие растения.;Рыхлая почва..."
	icon_state = "nutri"
...
/obj/machinery/vending/hydroseeds
	...
	product_slogans = "ИМЕННО ЗДЕСЬ ЖИВУТ СЕМЕНА!;Встань на колени перед лучшим автоматом семян на станции!;Возьми грибы разных видов!"
	product_ads = "Мы любим растения!;Давай вырастим это!;Расти, дорогой, расти..."
	icon_state = "seeds"
	products = list(
...
/obj/machinery/vending/voxseeds
	...
	product_slogans = "ИМЕННО ЗДЕСЬ ЖИВУТ СЕМЕНА!;Встань на колени перед лучшим автоматом семян на станции Воксов!;Продать, продать, продать!"
	product_ads = "Опять занимаешься незаконным заработком?;Выращивай, как мужчина!;Еда Воксов станет лучшей!"
	icon_state = "voxseed"
	products = list(
...
/obj/machinery/vending/magivend
	...
	icon_state = "MagiVend"
	product_slogans = "Используй заклинания вместе с нами!;Будь, как Гудини! Используй нашу продукцию!"
	vend_delay = 15
...
/obj/machinery/vending/dinnerware
	...
	product_ads = "Мм, столовые приборы!;Еда и столовые приборы.;Бери тарелки!;Нравятся ли тебе вилки?;Я люблю вилки.;Вау, посуда.;Они вам серьезно не нужны.."
...
/obj/machinery/vending/sovietsoda
	...
	product_slogans = "BODA: Вы продаем напитки.;BODA: сделай глоток!;BODA: Мы лучше Дэна."
	product_ads = "За Царя и Страну.;Сколько ты выпил сегодня?;Отлично!;Мы люди простые, видим ВОДУ - покупаем.;Если здесь стоит человек, это проблема. Если человека нет, то нет и проблемы"
	products = list(
...
/obj/machinery/vending/autodrobe
	...
	product_slogans = "Только в одежде ты успешен!;Одет и обут!;Время для шоу!;Зачем оставлять свой стиль судьбе? Используй АвтоДроб!"
	vend_delay = 15
...
/obj/machinery/vending/hatdispenser
	...
	product_ads = "Возьми себе шапку!;Голая голова ТОЧНО хочет попасть под робаст!"
	product_slogans = "Если вы увидите бегающий людей в наших шляпах и стреляющих друг по другу, то не удивляйтесь!;Надевать только на голову.;Кто-то не любит тратить деньги на шляпы?!;От человека, который подарил миру коллекционные шляпы - Лорд Шапок!"
	products = list(
...
/obj/machinery/vending/suitdispenser
	...
	product_ads = "Ищешь одежду? Лорд Костюмов для тебя!;БЕРИ МОЮ ПРОДУКЦИЮ!"
	product_slogans = "Чистая и свежая!;Кровь твоих врагов уже отмыта нами!;Что ты носишь?!;Ты выглядишь опрятно одетым!;Беспокоишься о размере? Потрать свои деньги ты, ленивый, толст - *БЗЗТ*"
	products = list(
...
/obj/machinery/vending/shoedispenser
	...
	product_ads = "Не будь хоббитом, используй Лорда Обуви.;Жмёт обувь? Бери нашу!"
	product_slogans = "Один размер для всех!;IM WALKING ON SUNSHINE!;Хоббитам покупка запрещена.;НЕТ, ВИЛЛИ, ПРОШУ, НЕ БЕЙ МЕ- *БЗЗТ*"
	products = list(
...
/obj/machinery/vending/discount
	...
	product_slogans = "Дискаунт Дэн, вот это человек!;Нет ничего в этом мире лучше, чем кусочек чего-то мистического.;Не слушайте другие машины, покупайте мои продукты!;Много и качественно!;Не слушайте этих яйцеголовых, покупай давай!;Дискаунт Дэн: все хорошее для вас!;Дискаун Дэн: только лучшее каче-*БЗЗТ*"
	product_ads = "Дискаунт Дэн(tm) не несёт ответственность за нанесенный покупателям вред."
...
/obj/machinery/vending/groans
	...
	product_slogans = "Гроанс: попробуй наши напитки!;Нашим спонсором является Дискаунт Дэн!;Сделай глоток!;Всего лишь глоток, ну же!"
	product_ads = "Попробуй наш новый \"Двойной Дэн\"!"
	vend_reply = "No refunds."
	icon_state = "groans"
	products = list(
...
/obj/machinery/vending/trader	// Boxes are defined in trader.dm
	...
	product_ads = "When you charge a customer $100, and he pays you by mistake $200, you have an ethical dilemma вЂ” should you tell your partner?"
