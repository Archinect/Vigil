		...
		if (src.authenticated)
			...
			if (href_list["field"])
				...
				switch(href_list["field"])
					...
					if("mi_dis_d")
						if (istype(src.active2, /datum/data/record))
							var/t1 = sanitize_russian(stripped_input("Please summarize minor dis.:", "Med. records", src.active2.fields["mi_dis_d"], null), 1)
							if ((!( t1 ) || !( src.authenticated ) || usr.stat || usr.restrained() || (!in_range(src, usr) && (!istype(usr, /mob/living/silicon))) || src.active2 != a2))
								return
					...
					if("ma_dis_d")
						if (istype(src.active2, /datum/data/record))
							var/t1 = sanitize_russian(stripped_input("Please summarize major dis.:", "Med. records", src.active2.fields["ma_dis_d"], null), 1)
							if ((!( t1 ) || !( src.authenticated ) || usr.stat || usr.restrained() || (!in_range(src, usr) && (!istype(usr, /mob/living/silicon))) || src.active2 != a2))
								return
					...
					if("alg_d")
						if (istype(src.active2, /datum/data/record))
							var/t1 = sanitize_russian(stripped_input("Please summarize allergies:", "Med. records", src.active2.fields["alg_d"], null), 1)
							if ((!( t1 ) || !( src.authenticated ) || usr.stat || usr.restrained() || (!in_range(src, usr) && (!istype(usr, /mob/living/silicon))) || src.active2 != a2))
								return
					...
					if("cdi_d")
						if (istype(src.active2, /datum/data/record))
							var/t1 = sanitize_russian(stripped_input("Please summarize diseases:", "Med. records", src.active2.fields["cdi_d"], null), 1)
							if ((!( t1 ) || !( src.authenticated ) || usr.stat || usr.restrained() || (!in_range(src, usr) && (!istype(usr, /mob/living/silicon))) || src.active2 != a2))
								return
							src.active2.fields["cdi_d"] = t1
					if("notes")
						if (istype(src.active2, /datum/data/record))
							var/t1 = sanitize_russian(stripped_input("Please summarize notes:", "Med. records", src.active2.fields["notes"], null), 1)
							if ((!( t1 ) || !( src.authenticated ) || usr.stat || usr.restrained() || (!in_range(src, usr) && (!istype(usr, /mob/living/silicon))) || src.active2 != a2))
								return
					...
					if("b_dna")
						if (istype(src.active1, /datum/data/record))
							var/t1 = sanitize_russian(stripped_input("Please input DNA hash:", "Med. records", src.active1.fields["dna"], null), 1)
							if ((!( t1 ) || !( src.authenticated ) || usr.stat || usr.restrained() || (!in_range(src, usr) && (!istype(usr, /mob/living/silicon))) || src.active1 != a1))
								return
					...
					if("vir_name")
						...
						if (v)
							var/t1 = sanitize_russian(stripped_input("Please input pathogen name:", "VirusDB", v.fields["name"], null), 1)
							if ((!( t1 ) || !( src.authenticated ) || usr.stat || usr.restrained() || (!in_range(src, usr) && (!istype(usr, /mob/living/silicon))) || src.active1 != a1))
								return
							v.fields["name"] = t1
					if("vir_desc")
