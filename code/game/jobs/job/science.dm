...
/datum/job/scientist
	...
	minimal_access = list(access_rnd, access_tox_storage, access_science, access_xenobiology, access_maint_tunnels)
...
/datum/job/roboticist
	...
	minimal_access = list(access_robotics, access_tech_storage, access_morgue, access_science, access_maint_tunnels) //As a job that handles so many corpses, it makes sense for them to have morgue access.
