...
//	preload_vox() //Causes long delays with initial start window and subsequent windows when first logged in.
	...
	getFiles(
		...
		'nano/css/shared.css',
		'nano/css/crewmonitor.css',
		'nano/css/html_interface_icons.css',
		'nano/css/map_shared.css',
		'nano/css/voting.css',
		'nano/css/RCD.css',
		'nano/css/nanotrasen.css',
		'nano/css/bootstrap.min.css',
		'nano/css/html_interface.css',
		'nano/css/cards.css',
		'nano/images/nanomapBackground.png',
		'nano/images/uiBg.png',
		'nano/images/uiBgcenter.png',
		'nano/images/uiBgtop.png',
		'nano/images/uiEyeGreen.png',
		'nano/images/uiEyeOrange.png',
		'nano/images/uiEyeRed.png',
		...
		'nano/js/jquery.min.js',
		'nano/js/jquery.mousehweel.js',
		'nano/js/crewmonitor.js',
		'nano/js/html_interface.js',
		'nano/js/bootstrap.min.js',
		'nano/js/Chart.js',
		'nano/js/3-jquery.timers.js',
		'nano/js/map_shared.js',
		'nano/js/advcamera.js',
		'nano/js/voting.js',
		...
		'nano/templates/html_interface.html',
		'nano/templates/html_interface_no_bootstrap.html',
