/mob/living/carbon/metroid/unarmed_attacked(mob/living/attacker, damage, damage_type, zone)
	.=..()

	if(health > 10)
		attacked += 10

/mob/living/carbon/metroid/get_unarmed_verb()
	return "glomps on"

/mob/living/carbon/metroid/get_unarmed_damage(mob/living/target)
	if(isslime(target))
		return rand(1,3)

	return rand(5, 35)

/mob/living/carbon/metroid/adult/get_unarmed_damage(mob/living/target)
	if(isslime(target))
		return rand(1,6)

	return rand(15, 40)

/mob/living/carbon/metroid/get_unarmed_hit_sound()
	return 'sound/weapons/welderattack.ogg'

/mob/living/carbon/metroid/proc/get_stun_chance()
	switch(powerlevel)
		if(1 to 2)
			return 20
		if(3 to 4)
...
/mob/living/carbon/metroid/unarmed_attack_mob(mob/living/target)
	if(target.isDead())
...
/mob/living/carbon/metroid/proc/stun_mob(mob/living/target, power)
	if(isliving(target))
