...
/mob/living/carbon/metroid/Destroy()
	..()
	Friends = null
	FriendsWeight = null
	Victim = null
...
/mob/living/carbon/metroid/Bump(atom/movable/AM as mob|obj)
	if(now_pushing)
		return
	now_pushing = 1
...
/mob/living/carbon/metroid/proc/attack_silme(mob/living/carbon/metroid/M)
	if (!ticker)
