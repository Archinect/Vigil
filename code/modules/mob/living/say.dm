...
var/list/department_radio_keys = list(
	  ...
	  ":c" = "Command",		":ñ" = "Command",		".c" = "Command",
	  ":n" = "Science",		":ò" = "Science",		".n" = "Science",
	  ":m" = "Medical",		":ì" = "Medical",		".m" = "Medical",
	  ":e" = "Engineering", ":ó" = "Engineering",	".e" = "Engineering",
	  ":s" = "Security",	":û" = "Security",		".s" = "Security",
	  ":w" = "whisper",		":ö" = "whisper",		".w" = "whisper",
	  ":b" = "binary",		":è" = "binary",		".b" = "binary",
	  ":a" = "alientalk",	":ô" = "alientalk",		".a" = "alientalk",
	  ":t" = "Syndicate",	":å" = "Syndicate",		".t" = "Syndicate",
	  ":r" = "Response Team",":ê" = "Response Team",".r" = "Response Team",
	  ":u" = "Supply",		":ã" = "Supply",		".u" = "Supply",
	  ":d" = "Service",     ":â" = "Service",       ".d" = "Service",
	  ":g" = "changeling",	":ï" = "changeling",	".g" = "changeling",
	  ":x" = "cultchat",	":÷" = "cultchat",		".x" = "cultchat",
	  ":y" = "ancientchat",	":í" = "ancientchat",	".y" = "ancientchat",
	  ":p" = "AI Private",	":ç" = "AI Private",	".p" = "AI Private",
	  ...
	  ":C" = "Command",		":Ñ" = "Command",		".C" = "Command",
	  ":N" = "Science",		":Ò" = "Science",		".N" = "Science",
	  ":M" = "Medical",		":Ü" = "Medical",		".M" = "Medical",
	  ":E" = "Engineering",	":Ó" = "Engineering",	".E" = "Engineering",
	  ":S" = "Security",	":Û" = "Security",		".S" = "Security",
	  ":W" = "whisper",		":Ö" = "whisper",		".W" = "whisper",
	  ":B" = "binary",		":È" = "binary",		".B" = "binary",
	  ":A" = "alientalk",	":Ô" = "alientalk",		".A" = "alientalk",
	  ":T" = "Syndicate",	":Û" = "Syndicate",		".T" = "Syndicate",
	  ":R" = "Response Team",":Ê" = "Response Team",".R" = "Response Team",
	  ":U" = "Supply",		":Ã" = "Supply",		".U" = "Supply",
	  ":D" = "Service",     ":Â" = "Service",       ".D" = "Service",
	  ":G" = "changeling",	":Ï" = "changeling",	".G" = "changeling",
